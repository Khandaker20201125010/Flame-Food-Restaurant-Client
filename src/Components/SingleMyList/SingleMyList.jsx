...
const SingleMyList = ({ item }) => {
    const { _id, shortDescription, country, price, quantity, foodCategory, foodName, name, email, Image, borrowedFoods } = item
    return (
        <div>
            <div>
                ...
                <div className='shadow-lg p-5 rounded-md flex flex-col border'>
                    ...
                    <Link to={`/UpdateFood/${_id}`}><button className=" w-full my-5 text-center px-4 py-2 rounded-md bg-orange-500 hover:bg-orange-400 border hover:border-red-500 text-white font-bold">Update</button></Link>
